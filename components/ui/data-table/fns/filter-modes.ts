...
export type GlobalFilterMode = 'fuzzy' | 'contains' | 'startsWith' | 'endsWith' | 'equals';
...
const num = (v: unknown): number => (typeof v === 'number' ? v : parseFloat(str(v)));
...
export const VALUELESS_MODES: ReadonlySet<FilterMode> = new Set(['empty', 'notEmpty']);
