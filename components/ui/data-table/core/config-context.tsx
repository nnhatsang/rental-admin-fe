...
export function DataTableConfigProvider({
  ...
  const value = React.useMemo(() => ({ icons, localization }), [icons, localization]);
  return <DataTableConfigContext.Provider value={value}>{children}</DataTableConfigContext.Provider>;
}
