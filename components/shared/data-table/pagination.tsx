...
interface DataTablePaginationProps<TData> {
  ...
  size?: 'sm' | 'default' | 'lg'; // Size prop for components  // Define any props you want to pass to the component here
}
function DataTablePagination<TData>({
  table,
  totalItems = 0,
  totalSelectedItems = 0,
  pageSizeOptions = sizeOptions, // Default options if none provided
  size = 'default',
