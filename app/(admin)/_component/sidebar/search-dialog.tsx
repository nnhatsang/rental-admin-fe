...
import { filterSidebarItemsByPermissions, sidebarItems, type NavGroup, type NavMainItem } from '@/navigation/sidebar/sidebar-items';
...
export function SearchDialog() {
  ...
  const visibleSidebarItems = React.useMemo(() => filterSidebarItemsByPermissions(sidebarItems, permissions), [permissions]);
